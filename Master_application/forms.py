...
class MasterForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['ownerAppartament'].queryset = User.objects.filter(appartament__isnull=False)
        ...
        self.fields['name_master'].queryset = User.objects.filter(role__user__isnull=False).distinct()
    ...
    class Meta:
        ...
        widgets = {
            ...
            'date_master': forms.DateInput(attrs={'class': 'form-control', 'id': 'datepicker', 'autocomplete': 'off', 'onkeyup': 'check_text_new(this)'}),
            'time_master': forms.TimeInput(attrs={'class': 'form-control bootstrap-timepicker' , 'id': 'timepicker', 'autocomplete': 'off', 'onkeyup': 'check_text_new(this)' })
        }